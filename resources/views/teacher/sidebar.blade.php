    ...
    <!-- Sidebar content goes here -->
        <div class="rounded-md border-[1px] border-solid border-gray-400 pt-4" aria-label="submenu">
            <div class="flex justify-center items-center">
                <img class="h-[150px] lg:h-[150px] " src="@if($data){{ asset('documents/' . $data->image) }}@endif" alt="">
            </div>
            <div class="flex flex-col justify-center items-center mt-2 text-[#05264e] font-semibold">
                <h1>@if($data){{$data->name}}@endif</h1>
                <h1>(TS-@if($data){{$data->id}}@endif)</h1>
            </div>
            <div class="my-5 py-2 bg-[#9d0a72]">
                <a href="{{ route('teacher.profile') }}"><h1 class="px-2 flex items-center text-white lg:text-[20px] text-[16px] leading-[26px] font-['Nunito,sans-serif']">
            ...
            <div class="my-5 px-2">
                <h1 class="flex items-center text-black lg:text-[20px] text-[16px] leading-[26px] font-['Nunito,sans-serif']">
                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M326.6 104H110.4c-51.1 0-91.2 43.3-91.2 93.5V427c0 50.5 40.1 85 91.2 85h227.2c51.1 0 91.2-34.5 91.2-85V0L326.6 104zM153.9 416.5c-17.7 0-32.4-15.1-32.4-32.8V240.8c0-17.7 14.7-32.5 32.4-32.5h140.7c17.7 0 32 14.8 32 32.5v123.5l51.1 52.3H153.9z"></path></svg>
                    Job Board</h1>
            </div>
            <div class="my-5 px-2">
                <a href="{{ route('teacher.notification') }}"><h1 class="flex items-center text-black lg:text-[20px] text-[16px] leading-[26px] font-['Nunito,sans-serif']">
            ...
            <div class="my-5 px-2">
                <a href="{{ route('teacher.profile_update') }}"><h1 class="flex items-center text-black lg:text-[20px] text-[16px] leading-[26px] font-['Nunito,sans-serif']">
            ...
            <div class="my-5 px-2">
                <a href="{{ route('teacher.upload_video') }}"><h1 class="flex items-center text-black lg:text-[20px] text-[16px] leading-[26px] font-['Nunito,sans-serif']">
                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M497.9 142.1l-46.1 46.1c-4.7 4.7-12.3 4.7-17 0l-111-111c-4.7-4.7-4.7-12.3 0-17l46.1-46.1c18.7-18.7 49.1-18.7 67.9 0l60.1 60.1c18.8 18.7 18.8 49.1 0 67.9zM284.2 99.8L21.6 362.4.4 483.9c-2.9 16.4 11.4 30.6 27.8 27.8l121.5-21.3 262.6-262.6c4.7-4.7 4.7-12.3 0-17l-111-111c-4.8-4.7-12.4-4.7-17.1 0zM124.1 339.9c-5.5-5.5-5.5-14.3 0-19.8l154-154c5.5-5.5 14.3-5.5 19.8 0s5.5 14.3 0 19.8l-154 154c-5.5 5.5-14.3 5.5-19.8 0zM88 424h48v36.3l-64.5 11.3-31.1-31.1L51.7 376H88v48z"></path></svg>
                    Upload Video</h1></a>
            </div>
            <div class="my-5 px-2">
            ...
            <div class="my-5 px-2">
                <h1 class="flex items-center text-black lg:text-[20px] text-[16px] leading-[26px] font-['Nunito,sans-serif']">
                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M408.781 128.007C386.356 127.578 368 146.36 368 168.79V256h-8V79.79c0-22.43-18.356-41.212-40.781-40.783C297.488 39.423 280 57.169 280 79v177h-8V40.79C272 18.36 253.644-.422 231.219.007 209.488.423 192 18.169 192 40v216h-8V80.79c0-22.43-18.356-41.212-40.781-40.783C121.488 40.423 104 58.169 104 80v235.992l-31.648-43.519c-12.993-17.866-38.009-21.817-55.877-8.823-17.865 12.994-21.815 38.01-8.822 55.877l125.601 172.705A48 48 0 0 0 172.073 512h197.59c22.274 0 41.622-15.324 46.724-37.006l26.508-112.66a192.011 192.011 0 0 0 5.104-43.975V168c.001-21.831-17.487-39.577-39.218-39.993z"></path></svg>
                    My Status</h1>
            </div>
            <div class="my-5 px-2">
                <h1 class="flex items-center text-black lg:text-[20px] text-[16px] leading-[26px] font-['Nunito,sans-serif']">
                    ...
                    Profile Verification Request</h1>
            </div>
            <div class="my-5 px-2">
                <a href="{{ route('teacher.security') }}"><h1 class="flex items-center text-black lg:text-[20px] text-[16px] leading-[26px] font-['Nunito,sans-serif']">
            ...
            <div class="my-5 px-2">
                <a href="{{ route('teacher.logout') }}"><h1 class="flex items-center text-black lg:text-[20px] text-[16px] leading-[26px] font-['Nunito,sans-serif']">
...
<div id="sidebar" class="overflow-auto overscroll-y-none z-10 lg:hidden h-full fixed top-0 left-0 bg-purple-300 w-64 text-white transform -translate-x-full transition-transform duration-300 ease-in-out">
    ...
    <div  class="px-2 rounded-md" aria-label="submenu">
        <div class="flex justify-center items-center">
            <img class="h-[150px] lg:h-[150px] " src="@if($data){{ asset('documents/' . $data->image) }}@endif" alt="">
        </div>
        <div class="flex flex-col justify-center items-center mt-2 text-[#05264e] font-semibold">
        ...
        <div class="my-5 py-2 bg-[#9d0a72]">
            <a href="{{ route('teacher.profile') }}"><h1 class="px-2 flex items-center text-black lg:text-[20px] text-[16px] leading-[26px] font-['Nunito,sans-serif']">
                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M326.6 104H110.4c-51.1 0-91.2 43.3-91.2 93.5V427c0 50.5 40.1 85 91.2 85h227.2c51.1 0 91.2-34.5 91.2-85V0L326.6 104zM153.9 416.5c-17.7 0-32.4-15.1-32.4-32.8V240.8c0-17.7 14.7-32.5 32.4-32.5h140.7c17.7 0 32 14.8 32 32.5v123.5l51.1 52.3H153.9z"></path></svg>
                Dashboard</h1></a>
        </div>
        <div class="my-5 px-2">
