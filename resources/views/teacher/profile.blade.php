...
<body>
    ...
    <main class="lg:ml-[280px] ml-0 mb-[100px] lg:mb-0 p-5">
            ...
            <div class="lg:w-[60%] w-[100%] border-[1px] border-solid border-gray-400 p-4">
                ...
                @if (true)
                    <div class="flex items-center border-[1px] border-solid border-gray-400 bg-[#f4b4c5] p-4 mt-3">
                        <strong>NB:</strong>
                        <p class="text-[#71132a] text-[14px]"> আপনার প্রোফাইলের তথ্য সঠিকভাবে পূরণ করে আমাদের "জব বোর্ডে" নিয়মিত এপ্লাই করুন।</p>
                    </div>
                @else
                    <div class="flex items-center border-[1px] border-solid border-gray-400 bg-[#f4b4c5] p-4 mt-3">
                        <strong>NB:</strong>
            ...
            <div class="lg:w-[38%] w-[100%] border-[1px] border-solid border-gray-400 bg-[#fff] shadow-2xl">
                <div class="flex p-5">
                    ...
                    <div>
                        ...
                        <p class="text-[#05264e] text-[18px] font-semibold">@if($data){{$data->Tuition_District}}({{$data->Tutor_Location}})@endif</p>
                    </div>
                </div>
        ...
        <div class="flex lg:flex-row flex-col justify-between lg:space-x-2 space-x-0 my-5">
            <div class="w-[100%] border-[1px] border-solid border-gray-400 bg-[#fff] shadow-2xl">
                <div class="flex p-5 w-[100%]">
                    <div class="flex justify-center items-center p-4  w-[35%]">
                        <img src="{{ asset('image/profile-user-svgrepo-com.svg') }}" alt="">
                    </div>
                    <div class="w-[65%]">
                        <p class="text-[#05264e] text-[20px] font-semibold">Welcome to</p>
                        <p class="text-[#05264e] mt-2">Please completed minimum 80% Profile Progress to apply your required tuitions. More informations helps us to reach you with your preferred tuition jobs.</p>
                    </div>
                </div>
                <a href="{{ route('teacher.profile_update') }}"><div class="flex justify-center items-center bg-[#c30c81] text-white p-2">
                    <p>Update Profile</p>
                </div></a>
            </div>
            <div class="w-[100%] border-[1px] border-solid border-gray-400 bg-[#fff] shadow-2xl">
                <div class="flex p-5 w-[100%]">
                    <div class="w-[35%] flex justify-center items-center p-4">
                        <img src="{{ asset('image/sand-clock-svgrepo-com.svg') }}" alt="">
                    </div>
                    <div class="w-[65%]">
                        <p class="text-[#05264e] text-[20px] font-semibold">Pending</p>
                        <p class="text-[#05264e] mt-2">Your pofile is on verification process. You can send us a profile verification Request. Verified profile will help you to get your preferred tuition easily</p>
                    </div>
                </div>
                <a href="{{ route('student.tutor_request') }}"><div class="flex justify-center items-center bg-[#c30c81] text-white p-2">
                    <p>Verify Profile</p>
                </div></a>
            </div>
            <div class="w-[100%] border-[1px] border-solid border-gray-400 bg-[#fff] shadow-2xl">
                <div class="flex p-5 w-[100%]">
                    <div class="w-[35%] flex justify-center items-center p-4">
                        <img src="{{ asset('image/window-premium-svgrepo-com.svg') }}" alt="">
                    </div>
                    <div class="w-[65%]">
                        <p class="text-[#05264e] text-[20px] font-semibold">Premium Request</p>
                        <p class="text-[#05264e] mt-2">Make your profile premium for one year to receive frequent tuition job updates & get prioritized your tuition job applications by Notifications.</p>
                    </div>
                </div>
                <a href="{{ route('student.tutor_request') }}"><div class="flex justify-center items-center bg-[#c30c81] text-white mt-6 p-2">
                    <p>Premium Profile Verification Request</p>
                </div></a>
            </div>
        </div>
        <div class="my-5">
        ...
        <div class="flex lg:flex-row flex-col justify-between lg:space-x-2 space-x-0">
            <div class="w-[100%] border-[1px] border-solid border-gray-400 bg-[#fff] shadow-2xl">
                ...
                <a href="{{ route('student.tutor_request') }}"><div class="flex justify-center items-center p-2 bg-gray-100 text-gray-500 hover:text-blue-500 border-t-[1px] border-solid border-gray-400">
                    <p>View List</p>
                </div></a>
            </div>
            <div class="w-[100%] border-[1px] border-solid border-gray-400 bg-[#fff] shadow-2xl">
