    ...
    <main class="lg:ml-[280px] ml-0 mb-[100px] lg:mb-0 p-5">
        ...
        @foreach ($datas as $data)
            <div class="flex lg:flex-row flex-col justify-between">
                ...
                <div class="lg:w-[34%] w-[100%] h-[400px] mt-5 text-[#05264e]" style="box-shadow: 0 0 15px 1px rgba(0,0,0,.4);">
                    <div class="p-5 text-[#05264e]">
                        <h1><span class="font-semibold">Creator Name: </span>{{$student[0]->name}}</h1>
                        <h1><span class="font-semibold">Creator Email: </span>{{$student[0]->email}}</h1>
                        <h1><span class="font-semibold">Creator Phone: </span>{{$student[0]->phone}}</h1>
                    </div>
                    ...
                    <div>
                        <form action="{{ route('job_status_change', ['id' => $data->id]) }}" method="post">
                            @csrf
                            <div class="flex flex-col items-center justify-center">
                                <div class="flex flex-col lg:w-[49%] w-[100%] py-2">
                                    <label for="status" class="text-[#05264e] text-[17px] font-semibold font-['adobe-garamond-pro']">Change Job Status</label>
                                    <select name="status" id="status" required
                                            class="status form-select border-[1px] border-solid border-[#ced4da] bg-[#fff] text-[#000] px-[10px] py-[6px]">
                                ...
                                <div class="mt-5">
                                    <button type="submit" class="bg-[#2098ce] hover:bg-[#2097cee0] rounded-lg text-white  text-[18px] px-4 py-[2px]">Save</button>
                                </div>
                            </div>
                        </form>
                    </div>
