    ...
    <div class="">
        <div class="hidden lg:block">
            <div class="flex justify-between items-center px-[150px] lg:h-[76px] h-[56px]">
                <div>
                    <a href="/">
                        <h1 class="w-[210px]"><img src="{{ asset('image/student.png') }}" alt=""></h1>
                    </a>
                </div>
                <div class="hidden lg:block">
        ...
        <div class="lg:hidden block w-full lg:w-auto mx-auto">
            <div class="flex justify-between items-center py-[8px] px-[5px]  lg:h-[76px] h-[56px]">
                <div>
                    <a href="/">
                        <h1 class="w-[210px] text-yellow-400 text-[24px]"><img src="{{ asset('image/student.png') }}" alt=""></h1>
                    </a>
                </div>
            ...
            <div id="dropdownMenu" class="text-white hidden bg items-center justify-between w-full md:flex md:w-auto">
                <div
                    ...
                    <div>
                        <a href="#"><h1 class="text-white text-[16px] font-bold border-b-2 border-transparent hover:border-blue-500 hover:transition-colors hover:duration-300">TUITION JOBS</h1></a>
                    </div>
                    <div>
                        <a href="#"><h1 class="text-white text-[16px] font-bold border-b-2 border-transparent hover:border-blue-500 hover:transition-colors hover:duration-300">PREMIUM TUTORS</h1></a>
                    </div>
                    <div>
                        <a href="#"><h1 class="text-white text-[16px] font-bold border-b-2 border-transparent hover:border-blue-500 hover:transition-colors hover:duration-300">TUTOR REQUEST</h1></a>
                    </div>
                    <div>
                        <a href="{{ route('student.logout') }}"
