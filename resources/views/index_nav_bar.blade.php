...
<nav class="fixed top-0 w-full z-10 lg:px-2 px-0 nav_bg">
    <div class="">
        <div class="hidden lg:block">
            <div class="flex justify-between items-center px-[100px] lg:h-[76px] h-[56px]">
                <div>
                    <a href="/">
                        <h1 class="w-[300px] text-yellow-400 text-[24px]"><img src="{{ asset('image/cooltext.png') }}" alt=""></h1>
                    </a>
                </div>
                <div class="hidden lg:block">
                        ...
                        <div>
                            <a href="{{ route('sign_up') }}"
                                class="block border-2 border-white hover:bg-blue-500 py-[5px] pl-3 pr-4 text-white text-[16px]"><i
                                    class="fa fa-sign-out-alt" style="font-size: 16px; color: white;"></i> Register</a>
                        </div>
                        <div>
                            <a href="{{ route('login') }}"
                                class="block border-2 border-white hover:bg-blue-500 py-[5px] pl-3 pr-4 text-white text-[16px]"><i
                                    class="fa fa-sign-out-alt" style="font-size: 16px; color: white;"></i> Login</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="lg:hidden block w-full lg:w-auto mx-auto">
            <div class="flex justify-between items-center py-[8px] px-[5px]">
                <div>
                    <a href="/">
                        <h1 class="w-[180px] text-yellow-400 text-[24px]"><img src="{{ asset('image/cooltext.png') }}" alt=""></h1>
                    </a>
                </div>
                    ...
                    <div>
                        <a href="{{ route('sign_up') }}"
                            class="block border-2 border-white hover:bg-blue-500 py-[5px] pl-3 pr-4 text-[16px]"><i
                                class="fa fa-sign-out-alt"></i> Register</a>
                    </div>
                    <div>
                        <a href="{{ route('login') }}"
                            class="block border-2 border-white hover:bg-blue-500 py-[5px] pl-3 pr-4 text-[16px]"><i
                                class="fa fa-sign-out-alt"></i> Login</a>
                    </div>
                </div>
            </div>
        </div>
