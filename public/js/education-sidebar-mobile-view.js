...
function classlist2() {
var mediumlist = document.getElementById('medium2').value;

//class
console.log(mediumlist)
if (mediumlist == '1'||mediumlist == '2'||mediumlist == '3') {
    var classlist = '<option selected value="all">All</option><option value="Class 1">Class 1</option><option value="Class 10">Class 10</option><option value="Class 2">Class 2</option><option value="Class 3">Class 3</option><option value="Class 4">Class 4</option><option value="Class 5">Class 5</option><option value="Class 6">Class 6</option><option value="Class 7">Class 7</option><option value="Class 8">Class 8</option><option value="Class 9">Class 9</option><option value="HSC-1st YEAR">HSC-1st YEAR</option><option value="HSC-2nd YEAR">HSC-2nd YEAR</option><option value="KG">KG</option><option value="Nursery">Nursery</option><option value="Play">Play</option><option value="SSC">SSC</option>'
}
if (mediumlist == '4') {
...
document.getElementById("class2").innerHTML = classlist;
}
