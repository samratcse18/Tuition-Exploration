    ...
    document.getElementById("Tuition_District2").innerHTML = disctList;

// Upazila Section select
function upazilaList2() {
    var DisList = document.getElementById('Tuition_District2').value;
    ...
    document.getElementById("Tutor_Location2").innerHTML = upazilaList;
}
...
function thanaList() {
    ...
    document.getElementById("Preferred_Tuition_Area2").innerHTML = thanaList;
}
